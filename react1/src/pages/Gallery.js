            ...
            buku: [
                {
                    ...
                    cover: "https://www.bukukita.com/babacms/displaybuku/95221_f.jpg"
                },
                {
                    isbn: "23456", judul: "Aliens", penulis: "Baggeb",
                    penerbit: "CV Telkom Indonesia", harga: "85000",
                    cover: "https://d1csarkz8obe9u.cloudfront.net/posterpreviews/aliens-ufo-book-cover-design-template-e73fc2e0e24fad8787d07c5a1d99146e_screen.jpg?ts=1637015324"
                }
            ],
            action: "",
            isbn: "",
                ...
                <div className="modal-content">
                    ...
                    <div className="modal-header">Form Buku</div>
                        ...
                        <div className="modal-body">
                            <form onSubmit={ ev => this.submitBook(ev) }>
                                Judul Buku
                                <input 
                                    type="text"
                                ...
                                Save
                                    ...
                                    |   <button className="btn btn-danger btn-block" onClick={this.close} type="button">
                                Close
                                </button>
                            </form>
                        </div>
